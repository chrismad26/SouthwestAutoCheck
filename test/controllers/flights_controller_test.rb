...
class FlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flight" do
    assert_difference('Flight.count') do
      post flights_url, params: { flight: { flightnum: @flight.flightnum, user_id: @flight.user_id } }
    end
  ...
  test "should update flight" do
    patch flight_url(@flight), params: { flight: { flightnum: @flight.flightnum, user_id: @flight.user_id } }
